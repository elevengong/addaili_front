            ...
            <div class="check">
                <div class="form_cont">
                    <div class="custom-control custom-radio custom-control-inline">
                        <input type="radio" id="customRadioInline1" name="user_type" value="2" class="custom-control-input web juser_type">
                ...
                <div class="input">
                    <div class="list">
                        <p>邮箱</p>
                        <input type="text" name="email" placeholder="请输入常用邮箱">
                    </div>
                    <div class="list">
                        <p>密码</p>
                        <input type="password" name="pwd" placeholder="请输入6-15个英文字母或数字的组合字符">
                    </div>
                    <div class="list">
                        <p>确认密码</p>
                        <input type="password" name="pwd_confirm" placeholder="请再输入一次密码">
                    </div>
                    <div class="list">
                        <p>QQ</p>
                        <input type="text" name="qq" onkeyup="value=value.replace(/[^\d]/g,'')" placeholder="请输入常用QQ号码，找回密码需要">
                    </div>
                    <div class="list">
                        <p>手机号码</p>
                        <input type="text" name="phone" onkeyup="value=value.replace(/[^\d]/g,'')" placeholder="请输入常用手机号，方便及时与您联系">
                    </div>
                    <div class="ty">
                        <input type="checkbox" name="regProtocol" id="regProtocol">
                        <p>我已经认真阅读并同意<a href="/protocol.html" target="_blank"><有盟网络广告平台服务协议></a></p>
                    </div>
