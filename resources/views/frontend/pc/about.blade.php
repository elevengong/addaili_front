...
<div class="about-page">
    <div class="container">
        ...
        <p>有盟，整合了智能手机领域大量优质媒体及广告资源，构建起一个公平、诚信、高效的广告营销服务平台，为广告主提供精准，高效的产品、品牌推广服务，同时为媒介主创造丰厚的广告收益。</p>

        <p>有盟运营团队拥有多年网络营销实战经验，塑造了多个网络知名品牌，培养了一批高水平的技术研发人员和一支专业的营销服务团队。</p>

        <p>有盟，以专业化的营销队伍，依靠先进的技术，科学规范的管理，强大的硬件设施和雄厚资金，我们有信心和实力为广大媒介主和广告主提供优质服务。</p>

        <p>热诚欢迎广大媒介主和广告主的加盟，共创美好未来!</p>

        <a href="join.html" class="join">加入我们</a>
    </div>
</div>
<!--about-page-->
...
<div class="page-7 contacts" style="background: url('{{url('/resources/views/frontend/pc/images/page-7.jpg')}}');">
