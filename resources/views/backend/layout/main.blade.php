...
<head>
    ...
    <title>广告联盟@if($type==1)广告商@else站长@endif后台</title>
</head>
<body>
<!--_header 作为公共模版分离出去-->
<header class="navbar-wrapper">
    <div class="navbar navbar-fixed-top">
        <div class="container-fluid cl">
            <a class="logo navbar-logo f-l mr-10 hidden-xs" href="#">广告联盟@if($type==1)广告商@else站长@endif后台</a>
            <span class="logo navbar-slogan f-l mr-10 hidden-xs">v3.0</span>
            <a aria-hidden="false" class="nav-toggle Hui-iconfont visible-xs" href="javascript:;">&#xe667;</a>

            <nav id="Hui-userbar" class="nav navbar-nav navbar-userbar hidden-xs">
                <ul class="cl">
                    <li>@if($type==1)广告商@else站长@endif</li>
                    <li class="dropDown dropDown_hover">
                        <a id="admin" href="#" class="dropDown_A">
                            {{$member}}<i class="Hui-iconfont">&#xe6d5;</i>
                        </a>
    ...
    <div class="menu_dropdown bk_2">
        <dl id="menu-article">
            ...
            <dd style="display: none">
                <ul>
                    <li><a data-href="{{url('/backend/adsmemberinfo')}}" href="javascript:void(0)" onclick="clicklink(this)" title="审核网站">广告主信息</a></li>
                </ul>
            </dd>
            @endif
            @if($type==3)
            <dd style="display: none">
                <ul>
                    <li><a data-href="{{url('/backend/adsmemberinfo')}}" href="javascript:void(0)" onclick="clicklink(this)" title="审核网站">站长信息</a></li>
                </ul>
            </dd>
            @endif
            ...
            <dd style="display: none">
                <ul>
                    <li><a data-href="{{url('/backend/ads/channel')}}" href="javascript:void(0)" onclick="clicklink(this)" title="广告渠道">广告渠道</a></li>
                </ul>
            </dd>

            <dt>
                <i class="Hui-iconfont">&#xe616;</i> 广告流量分析
                <i class="Hui-iconfont menu_dropdown-arrow">&#xe6d5;</i>
            </dt>
            ...
            @if($type==2)
            <dt>
                <i class="Hui-iconfont">&#xe616;</i> 网站管理
                <i class="Hui-iconfont menu_dropdown-arrow">&#xe6d5;</i>
            </dt>

            <dd style="display: none">
                <ul>
                    <li><a data-href="{{url('/backend/website/info')}}" href="javascript:void(0)" onclick="clicklink(this)" title="站长信息">站长信息</a></li>
                    <li><a data-href="{{url('/backend/website/lists')}}" href="javascript:void(0)" onclick="clicklink(this)" title="网站管理">网站管理</a></li>
                </ul>
            </dd>
            ...
            <dd style="display: none">
                <ul>
                    <li><a data-href="{{url('/backend/website/traffic')}}" href="javascript:void(0)" onclick="clicklink(this)" title="流量分析">流量分析</a></li>
                </ul>
            </dd>
            @endif
